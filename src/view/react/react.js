    ...
    return (
      <Router>
        <div className="react">
          <div className="top">
            <ul>
              <li><NavLink to="/react/State" exact>State</NavLink></li>
              <li><NavLink to="/react/Props" exact>Props</NavLink></li>
              <li><NavLink to="/react/Events" exact>Events</NavLink></li>
              <li><NavLink to="/react/Lifecycle" exact>Lifecycle</NavLink></li>
