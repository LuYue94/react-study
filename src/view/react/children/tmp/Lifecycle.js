    ...
    render() {
        ...
        return (
            <div>
                ...
                <hr />
                <h1>
                    <span>Unmounting</span>卸载
                </h1>
                <h2>componentWillUnmount()</h2>

                <hr />
                <h1>
                    <span>Error Handing</span>错误处理
                </h1>
                <h2>componentDidCatch(error, info)</h2>

                <hr />
                <h1>
                    <span>Other APIs</span>其他API
                </h1>
                <h2>setState()</h2>
                ...
                <h1>
                    <span>Class Properties</span>类属性
                </h1>
                <h2>defaultProps</h2>
                <h2>displayName</h2>
                <h1>
                    <span>Instance Properties</span>实例属性
                </h1>
                <h2>props</h2>
                <h2>state</h2>
            </div>
